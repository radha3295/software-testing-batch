...
public class Verify_holdings_tab {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		// create instance of ChromeOptions class
				...
				WebElement holdings=driver.findElement(By.xpath("(//span[text()='Holdings'])[1]"));
				holdings.click();
				
				WebElement holdingselector=driver.findElement(By.tagName("select"));
				Select s=new Select(holdingselector);
				s.selectByIndex(2);
